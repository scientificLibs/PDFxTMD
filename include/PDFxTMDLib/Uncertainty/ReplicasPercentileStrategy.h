...
namespace PDFxTMD
{
    /// @brief Strategy interface for calculating uncertainties using replicas and percentiles.
    class ReplicasPercentileStrategy : public IUncertainty
    {
    public:
        /// @brief Calculate the uncertainty based on replicas and percentiles.
