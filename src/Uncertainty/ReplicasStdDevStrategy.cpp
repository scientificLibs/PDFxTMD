...
namespace PDFxTMD
{
    void ReplicasStdDevStrategy::Uncertainty(const std::vector<double>& values, const int numCoreErrMember, const double cl, PDFUncertainty& uncertainty)
    {
        ...
        av /= numCoreErrMember; sd /= numCoreErrMember;
