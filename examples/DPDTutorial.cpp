...
int main()
{
    ...
    CollinearDPD cDPD("MSTW2008lo68cl_GSDPD_PDFxTMD", 0);
    ...
    auto res1 = cDPD.dpd(flavor1, flavor2, x1, mu1_2, x2, mu2_2);
    auto res2 = cPDF.pdf(flavor1, x1, mu1_2) * cPDF.pdf(flavor2, x2, mu2_2);
    std::cout << "DPD value is: " << res1 << "--facotrized: " << res2 << std::endl;
    return 0;
}